...
| Maintained package | Fresh `vps-terminal-dev` readback shows `/afhome/installed.yaml` still points `pr-af.source_path=/src/pr-af/go`, desired/status `running`, port `8007`, stale recorded PID `156016`, installed at `2026-09-09T16:50:12Z`. Exact `phases.go` SHA-256 is `7fc7234710046a64a40166570a3d4d2a27978bb7e6d80bb6024086a900063d00` in live source vs `4bc5188590cbadfdfb2f65060d3330d0c9bd5ce2454e32c7d5cdd0d3b7045928` in installed copy; installed binary SHA-256 is `7d8a714a67f1a7cbcedb7b5e72f2edb3e1b6d5d247c8a0258d71a25200edbb67`. `stat` proves `/afhome/packages/pr-af/bin/pr-af` is a regular copied file, not a symlink, so PR-AF restart alone cannot load the live-source repair. | DESIGN_RUNTIME_DRIFT / INSTALLED COPY STALE |
